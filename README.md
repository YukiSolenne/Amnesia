# Amnesia｜失忆图书馆
Google AI Studio试玩链接：https://ai.studio/apps/09fcdc33-e6e0-4578-b062-70cc71f357f9 持续更新中，里面加入了我个人写的一个独立小说的元素，但是没有完善游戏机制
（这个github的代码应该暂时不会变动了，因为是跑通的一个mvp用来做实验验证模型差异的）
